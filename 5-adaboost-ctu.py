...
def classify(x_train, y_train, x_test, y_test):
    '''
    Este método treina o adaboost com 5 estimadores utilizando os dados de treinamento e testa o adaboost utilizando os dados de teste.
    :param x_train:
    :param y_train:
    :param x_test:
    :param y_test:
...
if __name__ == "__main__":
    raiz = "/home/anderson/trabalhos/1-tese/data/ctu/6-train-test-final/"
